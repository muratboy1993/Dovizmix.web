#pragma checksum "C:\Users\exorc\OneDrive\Masaüstü\Yeni klasör (2)\DovizApp\UI.Mvc\Views\Company\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "beedc49b6c2126ea7b581663eada0e4fb08f9b60"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"beedc49b6c2126ea7b581663eada0e4fb08f9b60", @"/Views/Company/Index.cshtml")]
    ...
    public class Views_Company_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "C:\Users\exorc\OneDrive\Masaüstü\Yeni klasör (2)\DovizApp\UI.Mvc\Views\Company\Index.cshtml"
  
    ViewData["Title"] = "Index";

#line default
#line hidden
            BeginContext(43, 24849, true);
            WriteLiteral(@"
<style>
    table, th, td {
...
<h5>Kaynak Tekniği Sanayi ve Ticaret A.Ş. Gizlilik Politikası ve Çerez Uyarısı</h5>
<p>
    İşbu gizlilik politikası, Kaynak Tekniği Sanayi ve Ticaret A.Ş. (“Şirket”) tarafından işletilmekte olan www.askaynak.com.tr internet sitesinin (“Site”) işletilmesi sırasında Site kullanıcıları/ ziyaretçileri (“Veri Sahibi”) tarafından Şirket ile paylaşılan veya Şirketin, Veri Sahibinin Site’yi kullanımı sırasında ürettiği kişisel verilerin kullanımına ilişkin koşul ve şartları tespit etmektir.
</p>
<p>
...
<h6>Hangi Veriler İşlenmektedir?</h6>

<p>
    İşbu başlık altında, Şirket tarafından işlenen ve 6698 sayılı Kişisel Verilerin Korunması Kanunu (“Kanun”) uyarınca kişisel veri, gerçe");
            WriteLiteral(@"k kişileri belirli veya belirlenebilir kılan her türlü veridir. Aksi açıkça belirtilmedikçe, işbu Gizlilik Politikası kapsamında arz edilen hüküm ve koşullar kapsamında “Kişisel Veri” ifadesi aşağıda yer alan bilgileri kapsayacaktır:
</p>
<ul>
    <li>
        İletişim Bilgisi
...
<p>
    Kanun’un 3. ve 7. maddeleri dairesince anonim hale getirilen veriler, anılan kanun hükümleri uyarınca Kişisel Veri olarak kabul edilmeyecek ve bu verilere ilişkin işleme faaliyetleri işbu gizlilik politikası hükümleri ile bağlı olmaksızın gerçekleştirilecektir.
</p>

<h6>Veriler Hangi Amaçlarla Kullanılmaktadır?</h6>

<p>
    Şirket, Veri Sahibi tarafından sağlanan Kişisel Verileri Şirket");
            WriteLiteral(@" tarafından sunulan ürün ve hizmetlerin ilgili kişilerin beğeni, kullanım alışkanlıkları ve ihtiyaçlarına göre özelleştirilerek ilgili kişilere önerilmesi ve tanıtılması için gerekli olan aktivitelerin planlanması ve icrası amacıyla işleyebilecektir.
</p>

<p>
    Şirket, Kanun’un 5 ve 8. maddeleri uyarınca veya ilgili mevzuattaki istisnaların varlığı halinde Kişisel Verileri, Veri Sahibinin ayrıca rızasını almaksızın işleyebilecek ve üçüncü kişilerle paylaşabilecektir. Bu durumların başlıcaları şunlardır:
</p>
...
<h6>Verilere Kimler Erişebilmektedir?</h6>

<p>
    Şirket, Veri Sahibine ait Kişisel Verileri ve bu Kişisel Verileri kullanılarak elde ettiği yeni verileri, işbu Gizlilik Politikası ile belirlenen amaçların gerçekleştirilebilmesi için Şirketin hizmetlerinden faydalandığı üçüncü kişilere, söz konusu hizmetlerin temini amacıyla sınırlı olmak üzere aktarılabilecektir. Şirket ayrıca, işbu gizlilik politikasında belirtilen amaçlar dahilinde verileri, Şirketin iş ortakları, tedarikçileri ve hukuken yetkili kurum ve kuruluşlara");
            WriteLiteral(@" aktarabilecektir.
</p>

<p>
    Şirket, Veri Sahibi deneyiminin geliştirilmesi (iyileştirme ve kişiselleştirme dâhil), Veri Sahibinin güvenliğini sağlamak, hileli ya da izinsiz kullanımları tespit etmek, operasyonel değerlendirme araştırılması, Site hizmetlerine ilişkin hataların giderilmesi ve işbu gizlilik politikasında yer alan amaçlardan herhangi birisini gerçekleştirebilmek için SMS gönderimi yapanlar da dahil olmak üzere dış kaynak hizmet sağlayıcıları, barındırma hizmet sağlayıcıları (hosting servisleri), hukuk büroları, araştırma şirketleri, çağrı merkezleri gibi üçüncü kişiler ile paylaşabilecektir.
</p>
...
<ul>
    <li>
        Kanun’un 11. maddesi uyarınca ve");
            WriteLiteral(@"ri sahipleri,
    </li>
    <li>
    ...
    <li>
        İşlenen verilerin münhasıran ot");
            WriteLiteral(@"omatik sistemler vasıtasıyla analiz edilmesi suretiyle kişinin kendisi aleyhine bir sonucun ortaya çıkmasına itiraz etme,
    </li>
    <li>
...
<p>
    Veri Sahibi, işbu gizlilik politikasına konu bilgilerinin tam, doğru ve güncel olduğunu, bu bilgilerde herhangi bir değişiklik olması halinde bunları derhal güncelleyeceğini taahhüt eder.");
            WriteLiteral(@" Veri Sahibinin güncel bilgileri sağlamamış olması halinde Şirketin herhangi bir sorumluluğu olmayacaktır.
</p>
...
<p>
    Şirket, i");
            WriteLiteral(@"lgili mevzuatta belirlenen veya işbu Gizlilik Politikası’nda ifade edilen şartlarda;
</p>
...
<p>
    Veri Sahiplerinin Site’den en verimli şekilde faydalanabilmesi ve kullanıcı deneyiminin geliştiril");
            WriteLiteral(@"mesi için Site’de kullanılmaktadır. Çerez kullanılmasını tercih etmezseniz tarayıcınızın ayarlarından çerezleri silebilir ya da engelleyebilirsiniz. Ancak Site kullanımınızı etkileyebileceğini hatırlatmak isteriz. Tarayıcınızdan Cookie ayarlarınızı değiştirmediğiniz sürece bu Site’de çerez kullanımını kabul ettiğinizi varsayacağız.
</p>
...
<p>
    Çerez, ziyaret ettiğiniz internet siteleri tarafından tarayıcılar aracılığıyla cihazınıza veya ağ sunucusuna depolanan küçük metin dosyalarıdır. Çerezler konusundan daha detaylı bilgi için 
...
<ul>
    <li>
        İnternet sitesinin işlevselliğini ve performansını arttırmak yoluyla sizlere s");
            WriteLiteral(@"unulan hizmetleri geliştirmek,
    </li>
    <li>
...
<br />
<h6>Site’de Kullanılan Çerezler</h6>
...
<table>
    ...
    <tr>
        ...
        <th>
            Kullanıcının IP adresi sayesinde yaklaşık adresinin (şehir, ilçe, posta kodu) belirlenmesini ve kullanıcının bu şekilde otomatik olarak kendi ülkesini seçmesini ve o bölgedeki perakendeciler ile tanıtı");
            WriteLiteral(@"m günlerinin gösterilmesini sağlar.
    ...
    <tr>
        ...
        <th>
            ...
            WriteLiteral(@"
            <a href=""https://tools.qooqle.com/dlpaqe/qaoptout"">https://tools.qooqle.com/dlpaqe/qaoptout</a>
        </th>
    </tr>
    <tr>
        <th>
        ...
        <th>
            Bu tür çerezler tüm istatistiksel verilerin toplanmasını bu şekilde Sitenin sunumunun ve kullanımının geliştirilmesini sağlar.
    ...
    <tr>
        ...
        <th>
            Kullanıcılara sitemizi son ziyaretlerinden ");
            WriteLiteral(@"itibaren neler değiştiğine ilişkin güncellemelerde bulunmak ve kullanıcıların tercihlerini daha iyi anlamak için kullanılır.
    ...
    <tr>
        ...
        <th>
            Sayfa geçmişi çerezleri, kullanıcıların hangi sırayla hangi siteleri ziyaret ettiğini takip etmek için kullanılır. Eğer kullanıcı Siteyi ziyaret ettiğinde bir hatayla karşılaşırsa, çerez bilgisi hatanın raporlanması ve çözümü için log dosyasına ka");
            WriteLiteral(@"ydolur.
    ...
    <tr>
        ...
        <th>
            Güvenlik çerezler, güvenlik kontrolle");
            WriteLiteral(@"ri için kullanılır.
